			...
			if(user != null){
				...
				if(roleId == 1 || roleId == 8){
					...
					if(rowsUpdated == 1){
						...
						request.setAttribute("error", "Ocurrió un error durante la eliminación del usuario. Por favor intente de nuevo y si el error persiste contacte a su administrador.");
						rd = getServletContext().getRequestDispatcher("/ListUsersServlet");			
