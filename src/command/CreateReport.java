...
public class CreateReport implements DatabaseCommand {
	...
	private String baseQuery = "SELECT C.IDENTITY_CARD, C.LAST_NAME, C.FIRST_NAME, CP.AFFILIATION_DATE, P.NAME AS PRODUCT_NAME, P.PRICE, " +
			...
			"CA.PROPERTY_NAME, CA.TOWER, CA.FLOOR, CA.APARTMENT, CA.URBANIZATION, CA.MUNICIPALITY, CA.POSTAL_CODE, CA.CITY, CA.STATE, " +
	...
	public Object executeDatabaseOperation(Connection conn) throws SQLException {
		...
		while(rs.next()) {
			...
			reportItem.setCity(rs.getString(19));
			reportItem.setState(rs.getString(20));
			reportItem.setHomeNumber(rs.getString(21));
			reportItem.setOfficeNumber(rs.getString(22));
			reportItem.setMobileNumber(rs.getString(23));
			reportItem.setFaxNumber(rs.getString(24));
			reportItem.setEmail(rs.getString(25));
